    ...
    <body>
        ...
        <header class="navbar-fixed">
            ...
            <ul style="width:225px; margin-top:65px;" class="side-nav fixed">
                ...
                <li><a href="inicio-panel.php"><i class="material-icons">reorder</i>Inicio</a></li>
                <li><a href="#"><i class="material-icons">account_circle</i>Cajeros</a></li>
                <li><a href="#"><i class="material-icons">insert_chart</i>Estadisticas</a></li>
                <li><a href="#"><i class="material-icons">view_carousel</i>Mesas</a></li>
                <li><a href="#"><i class="material-icons">system_update_alt</i>Ofertas</a></li>
                <li><a href="#"><i class="material-icons">shopping_cart</i>Reservas</a></li>
                <li><a href="#"><i class="material-icons">people</i>Clientes</a></li>
                <li><a href="#"><i class="material-icons">email</i>Notificaciones</a></li>
            </ul>
        </header>
        <div class="row">
            <div class="row">
